            ...
            <div className="glass-panel px-6 py-5 lg:px-8 lg:py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                >
                    <input
                        type="email"
                        placeholder="Email"
                        className="bg-gray-800/60 border border-gray-700/50 text-gray-300 placeholder-gray-500 text-sm rounded-lg px-4 py-2.5 w-full sm:w-56 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all"
                    />
                    <button
                        type="submit"
                        className="bg-white hover:bg-gray-200 text-background-dark p-2.5 rounded-lg transition-colors flex-shrink-0"
