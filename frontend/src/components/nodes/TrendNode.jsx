...
const TrendNode = ({ variant = 'trends' }) => {
    if (variant === 'analysis') {
        return (
            ...
            <ul className="space-y-4">
                <li>
                    <a href="#" className="flex flex-col group">
                        ...
                        <span className="text-[10px] text-gray-500">High Frequency Interaction</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex flex-col group">
                        ...
                        <span className="text-[10px] text-gray-500">Emerging Sub-field</span>
                    </a>
                </li>
            </ul>
        </aside>
