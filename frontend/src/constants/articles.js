// Centralized article data — used by NodeCanvas, Topics, DeepDives, Analysis, and ArticlePage
...
const articles = [
    {
        ...
        description: 'From neuromorphic computing to photonic chips, exploring the cutting-edge engineering behind modern AI hardware.',
        category: 'Deep Dive',
        tag: 'CENTRAL NODE: DEEP DIVE',
        isHero: true,
        ...
        body: [
            ...
            { type: 'paragraph', content: 'Cerebras\' Wafer-Scale Engine, for instance, takes the unprecedented approach of using an entire silicon wafer as a single chip — 46,225 mm² of compute surface area compared to the ~800 mm² of a typical GPU. This eliminates the inter-chip communication bottleneck that plagues traditional multi-GPU setups.' },
    ...
    },
    {
        ...
        readTime: '8 min read',
        body: [
            { type: 'paragraph', content: 'The autonomous vehicle industry has long been bottlenecked by sensor limitations. While cameras provide rich visual data and radar offers reliable distance measurement, neither alone can deliver the precision needed for Level 4 autonomy — where the vehicle handles all driving tasks in most conditions.' },
    ...
    },
    {
        ...
        body: [
            ...
            { type: 'paragraph', content: 'The primary challenge has always been manufacturing. Growing high-quality, large-area graphene consistently and affordably seemed nearly impossible at scale. But recent breakthroughs in chemical vapor deposition (CVD) on copper foils have yielded meter-scale graphene sheets with electronic-grade quality.' },
            { type: 'paragraph', content: 'Samsung\'s Advanced Materials Lab has demonstrated roll-to-roll graphene production at costs approaching $1 per square meter — a 1000x reduction from five years ago. This cost trajectory mirrors early silicon manufacturing curves.' },
    ...
    },
    {
        ...
        description: 'Ultra-precise magnetic field detection is enabling non-invasive brain imaging breakthroughs.',
        category: 'Sensors',
    ...
    },
    {
        ...
        description: 'Modular chip design is changing how processors are manufactured and scaled.',
        category: 'Deep Dive',
        author: 'Kevin Zhang',
        date: 'Feb 3, 2026',
        ...
        body: [
            ...
            { type: 'paragraph', content: 'The benefits are profound: higher manufacturing yields (smaller dies have fewer defects), mix-and-match process optimization (compute on 3nm, I/O on 7nm), and the ability to scale performance by simply adding more chiplets.' },
    ...
    },
    {
        ...
        description: 'Lab results show 33.9% efficiency, closing the gap with traditional silicon.',
        category: 'Materials',
        ...
        body: [
            ...
            { type: 'paragraph', content: 'The Achilles\' heel of perovskites remains long-term stability. While silicon panels reliably operate for 25+ years, early perovskite cells degraded within months. Recent encapsulation breakthroughs and compositional engineering have extended lab lifetimes to over 10,000 hours under accelerated testing — but the industry target of 25-year warranties remains a few years away.' },
        ],
    },
    {
        id: 10,
        title: 'Swarm Robotics for Warehouse Logistics',
        description: 'Coordinated micro-robots are outperforming single-arm systems in pick-and-place tasks.',
        category: 'Robotics',
        author: 'Tom Bradley',
        date: 'Jan 28, 2026',
        readTime: '6 min read',
    ...
    },
    {
        ...
        description: 'Training models across distributed devices without centralizing sensitive data.',
        category: 'Edge Computing',
        ...
        body: [
            ...
            { type: 'paragraph', content: 'Google pioneered this approach for keyboard prediction on Android phones. Now it\'s being adopted in healthcare (training diagnostic models across hospitals without sharing patient records), finance (fraud detection across banks), and industrial IoT (predictive maintenance across factory floors).' },
    ...
    },
    {
        ...
        description: 'The transition from mechanical spinning to solid-state is accelerating mass adoption.',
        category: 'Sensors',
        author: 'Alex Rivera',
        date: 'Jan 22, 2026',
        readTime: '7 min read',
    ...
    },
    {
        ...
        description: 'Analyzing the $120B trajectory of AI accelerator silicon and who stands to dominate.',
        category: 'Analysis',
    ...
    },
    {
        ...
        description: 'Mapping geopolitical dependencies and single-point failures in global chip production.',
        category: 'Analysis',
        author: 'Flyback Research',
        date: 'Feb 19, 2026',
        readTime: '12 min read',
        body: [
            ...
            { type: 'paragraph', content: 'Our analysis identifies five critical chokepoints where single-point-of-failure risks are most acute: advanced lithography (ASML, Netherlands), leading-edge foundry (TSMC, Taiwan), advanced packaging substrates (Ibiden/Shinko, Japan), neon gas supply (Ukraine/China), and EDA software (Synopsys/Cadence, USA).' },
    ...
    },
    {
        ...
        description: 'Why shrinking nodes no longer guarantee cheaper chips — and what that means for the industry.',
        category: 'Analysis',
        author: 'Flyback Research',
        date: 'Feb 16, 2026',
        readTime: '8 min read',
    ...
    },
    {
        ...
        description: 'Tracking fab construction, utilization rates, and regional investment across 12 countries.',
        category: 'Analysis',
        author: 'Flyback Research',
        date: 'Feb 14, 2026',
        readTime: '9 min read',
        body: [
            ...
            { type: 'paragraph', content: 'After the post-pandemic glut drove utilization below 70% in early 2024, the industry has recovered to a healthier 82% average. Leading-edge fabs (sub-7nm) are running at a tight 93%, while mature nodes have stabilized at 78%. Memory fabs, after aggressive production cuts, have climbed back to 85%.' },
...
// Auto-generate slug for each article from its title
articles.forEach((a) => { a.slug = slugify(a.title) })
